<template>
    <div :style="containerClass" @pointerdown="onPointerDown" @pointermove="onPointerMove" @pointerup="endDrag"
...
export default {
    ...
    methods: {
        ...
        animate: function () {
            ...
            var step = function () {
                if (!self.drag && self.$refs.textPathRef) {
                    ...
                    var currentOffset = parseFloat(self.$refs.textPathRef.getAttribute('startOffset') || '0');
        ...
        onPointerMove: function (e) {
            ...
            var currentOffset = parseFloat(this.$refs.textPathRef.getAttribute('startOffset') || '0');
