<template>
    <span ref="containerRef" :class="`inline-block whitespace-pre-wrap ${parentClassName}`"
    ...
    mounted: function () {
        if (this.animateOn === 'view') {
            ...
            this.$nextTick(function () {
                ...
                self.intersectionObserver = new IntersectionObserver(observerCallback, observerOptions);
    ...
    methods: {
        ...
        shuffleText: function (originalText, currentRevealed) {
            ...
            if (this.useOriginalCharsOnly) {
                ...
                var nonSpaceChars = positions.filter(function (p) {
                ...
                return originalText.split('').map(function (char, i) {
                    if (char === ' ') return ' ';
            ...
            if (this.isHovering) {
                ...
                this.interval = setInterval(function () {
                    if (self.sequential) {
                        ...
                        self.displayText = self.shuffleText(self.text, self.revealedIndices);
